...
- `docs/architecture.md` — layered architecture + pointers into `DESIGN.md` / `tech-stack-pyside6.md`
...
- `docs/specs-plans.md` — pointer into `docs/superpowers/{specs,plans}/` plus the root design artifacts

## Status

Pre-scaffold. `DESIGN.md` (canonical) and `tech-stack-pyside6.md` (operational scaffold notes) are the design artifacts. First scaffold step is `tech-stack-pyside6.md` §11 — `pyproject.toml` + `uv` lockfile + repo skeleton.
