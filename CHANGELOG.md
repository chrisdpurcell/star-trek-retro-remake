...
- Per-repo handoff system (`.claude/`, `docs/`, `CLAUDE.md`) per `/mnt/share/claude-handoff-system.md`
...
The project is currently pre-scaffold — design and documentation only. The first scaffold (`v0.1.0`) lands when `pyproject.toml`, the `src/stmrr/` skeleton, and the initial ADRs are committed. See `docs/design/tech-stack-pyside6.md` §11 for the scaffold step order.
