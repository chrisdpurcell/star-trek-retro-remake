...
- An AI image-generation API key is needed for the asset pipeline (`tech-stack-pyside6.md` §14). Likely path: `secret/api-keys/ai/openai`.
- A GitHub Actions deploy key or release-token is wired up (`tech-stack-pyside6.md` §13.4 lists `.github/workflows/ci.yml` as a first-scaffold-push artifact).
